          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-on-scroll fade-right">
              ...
              <div className="space-y-6 text-gray-400 leading-relaxed">
                <p>
                  Mohanty & Sons Private Limited (MSPL) is a premier industrial fabrication and erection company based in Eastern Odisha. With over 60 years of unwavering commitment to the industry, we have established ourselves as a key partner for heavy industries across the region.
                </p>
                <p>
