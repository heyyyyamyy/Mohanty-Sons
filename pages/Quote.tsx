              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input type="text" className="w-full bg-brand-dark border border-white/10 p-4 text-white outline-none focus:border-brand-yellow transition-colors" placeholder="₹" />
                  </div>
                </div>
