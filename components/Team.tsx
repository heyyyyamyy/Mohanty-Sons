...
const Team: React.FC = () => {
  const team = [
    { name: "Akshaya Kumar Mohanty", role: "Director", img: "/AKSHAYA KUMAR MOHANTY.png" },
    { name: "Ajay Kumar Mohanty", role: "Director", img: "/AJAY KUMAR MOHANTY.png" },
    { name: "Amulya kumar Mohanty", role: "Manager", img: "/managerImage.jpg" },
